const FeaturedCard = ({ image, title, featureDes }) => {
  return (
    <div className="md:h-44 py-3 flex items-center justify-center px-4 text-center rounded-xl border-white border bg-black bg-opacity-10 backdrop-blur-md duration-500 text-white">
      <div>
